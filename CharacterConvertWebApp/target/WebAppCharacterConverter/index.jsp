...
<body>
		...
		<div class="row">
          ...
          <form role="form" class="form-inline" action="CharacterConvertWebApp">
            <div class="form-group" >
				...
				<form role="form" id="chaineAEnvoyer">
					<div class="row">
						...
						<div class="col-md-8">
							<label for="caractere" id="caractere" class="sr-only">Caractère
								: </label> <input type="caractere" class="form-control" id="carrrr"
	...
	<div class="blog-footer">
		<p>
			Touts droits réservée au Group <a
				...
				by: </b>Yoann Pigné<br /> <b>Client developed by: </b>Saidane,
			Roshanak, Mounir, Hilali<br /> <b> Serveur developed by: </b>Jason,
			Quentin, Mounirit, Bastien
		</p>
		<p></p>
	</div>
    ...
    $(document).ready( function () {
    	...
    	$("#submit").click(function() {
			var chaineCaractere = { chaine : $('#carrrr').val() };
